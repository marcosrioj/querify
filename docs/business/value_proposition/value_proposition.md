...
**Transforme cada pergunta em um ativo reutilizável, resolva interações 1:1 e 1:N em qualquer canal e aprenda com cada conversa para melhorar a próxima resposta.**

## Versão Expandida

Um único sistema para capturar dúvidas de clientes e comunidades, responder com consistência e transformar padrões de interação em um centro de conhecimento.
...
| É pergunta, resposta, fonte, tag, visibilidade, versão ou conteúdo reutilizável? | QnA | QnA guarda o centro de conhecimento, mas não guarda fluxo de conversa privada, comentário público ou decisão auditável. |
| É uma conversa direcionada a uma pessoa, conta, cliente, usuário ou membro específico? | Direct | Direct consulta QnA para responder, mas é dono de mensagens, contexto 1:1, handoff e escalação. |
...
| --- | --- | --- |
| Suporte e sucesso do cliente | Direct para conversas privadas; QnA para respostas canônicas; Trust para temas sensíveis | Um segundo dono de conversas, respostas ou validação. |
| Marketing e crescimento | Broadcast para sinais públicos; QnA para narrativas reutilizáveis; Direct para follow-up privado | Um módulo paralelo de campanha, social ou resposta pública. |
...
3. O resultado precisa virar conteúdo reutilizável, validação auditável ou apenas sinal operacional?
...
O centro de conhecimento da empresa.

Ele transforma perguntas recorrentes, respostas canônicas e aprendizados de suporte em uma base reutilizável para todos os canais.
...
- Espaços de conhecimento, perguntas canônicas, respostas reutilizáveis, fontes, tags e visibilidade.
- Curadoria, publicação, versionamento e status de perguntas e respostas.
- Proveniência: canal de entrada, fonte de origem, evidência e referência.
- Distribuição de respostas do centro de conhecimento para sites, apps, portais, documentação, Direct e Broadcast.
- Lacunas de cobertura quando uma interação ainda não tem resposta reutilizável.
...
- E-commerce, páginas de produto, checkout, status de pedido e pós-venda, quando a necessidade é uma resposta reutilizável.
...
- Produtos SaaS em onboarding, cobrança, configurações, permissões, segurança e integrações, quando a necessidade é ajuda contextual consistente.
...
**Valor principal:** velocidade de resolução. Cada conversa individual deixa de ser apenas atendimento e passa a alimentar o QnA para futuras interações.
...
- Resposta canônica reutilizável, fonte oficial, tag, visibilidade pública ou ciclo editorial QnA. Isso pertence ao QnA.
- Resposta pública, comentário social, thread comunitária, live, fórum ou grupo compartilhado. Isso pertence ao Broadcast.
- Validação auditável, votação, decisão coletiva ou racional formal. Isso pertence ao Trust.
...
- Coordenação de resposta pública usando o centro de conhecimento.
...
- Resposta canônica como fonte reutilizável. Isso pertence ao QnA.
- Votação formal, priorização auditável, decisão coletiva ou histórico de decisão. Isso pertence ao Trust.
...
- Validação, aceite formal, contestação, voto, regras de decisão, racional e histórico auditável.
- Processos de revisão para respostas, contribuições comunitárias, políticas, propostas, roadmap e decisões sensíveis.
- Registro de quem participou, qual regra foi aplicada, qual resultado foi aceito e qual versão deve ser usada.
- Evidência e trilha de auditoria quando uma resposta, decisão ou política precisa ser explicável.
- Publicação de status, racional ou decisão para QnA quando esse resultado deve ser reutilizado.
...
2. O sistema classifica o dono da interação: QnA para conteúdo próprio, Direct para conversa privada, Broadcast para espaço compartilhado e Trust para decisão ou validação auditável.
3. O módulo de entrada consulta QnA quando precisa de uma resposta do centro de conhecimento.
4. Se existir uma resposta no QnA, o módulo de entrada entrega no canal certo sem assumir a posse editorial do conhecimento.
5. Se não existir uma resposta no QnA, o módulo de entrada registra lacuna, evidência ou sinal no seu próprio contexto e encaminha a curadoria para QnA.
6. Se a lacuna exige validação formal, voto, contestação ou histórico auditável, Trust registra a decisão antes ou depois da publicação no QnA.
7. A resposta, decisão ou política publicada volta para Direct, Broadcast e superfícies QnA como conteúdo reutilizável.
...
| Situação | Dono da interação | Dono do conteúdo reutilizável | Dono de validação ou decisão | Limite de não conflito |
| --- | --- | --- | --- | --- |
| Pergunta em site, app, documentação ou portal de autoatendimento | QnA | QnA | Trust, quando validação auditável for necessária | Se virar conversa personalizada, o trecho privado passa para Direct. |
| Conversa 1:1 de suporte, sucesso, vendas, parceiro ou cliente | Direct | QnA, apenas quando a resposta final entra no centro de conhecimento | Trust, quando houver decisão sensível ou validação formal | Direct não armazena resposta canônica; QnA não armazena mensagens e handoff. |
| Comentário, menção, post, live ou resposta pública | Broadcast | QnA, apenas quando o padrão vira pergunta ou resposta reutilizável | Trust, quando houver política, moderação formal ou validação auditável | Broadcast não vira base editorial; QnA não vira caixa de comentários. |
...
- Direct para QnA: uma conversa privada revela uma lacuna ou resposta final que deve entrar no centro de conhecimento.
...
- QnA para Trust: uma resposta, fonte, política ou status precisa de validação formal, contestação, voto, racional ou auditoria.
...
| --- | --- | --- | --- |
| 1. Pergunta Conhecida -> Resposta Imediata | Um cliente pergunta algo que já foi catalogado antes. | QnA fornece a resposta canônica; QnA entrega em superfície própria, Direct entrega em conversa privada ou Broadcast entrega em espaço visível por muitos. O módulo de entrada mantém a posse da interação. | Reduz tickets, aumenta consistência e evita que times diferentes respondam a mesma dúvida de formas diferentes. |
| 2. Pergunta Nova -> Ativo Reutilizável | Uma pergunta aparece sem resposta no QnA. | Direct registra lacuna se a origem é privada; Broadcast registra lacuna se a origem é pública ou compartilhada; QnA assume a curadoria da resposta; Trust valida quando houver risco ou decisão formal. | Cada falha de cobertura vira ativo permanente sem mover fluxo de canal para QnA. |
| 3. Atendimento 1:1 -> Conhecimento Para Todos | Um agente ou o Direct resolve uma dúvida individual. | Direct mantém conversa, mensagens, handoff e resolução; QnA recebe apenas a resposta reutilizável depois de revisão; Trust participa se a resposta exigir validação auditável. | O custo de uma conversa individual gera retorno em escala. |

### Social, Comunidade E Conversão

| Processo | Situação | Módulos sem conflito | Valor |
| --- | --- | --- | --- |
| 4. Comentário Público -> Resposta Segura | Alguém faz uma pergunta ou objeção em comentário público. | Broadcast captura e responde no canal; QnA sugere ou recebe resposta canônica; Trust participa somente quando a resposta exige validação formal. | Aumenta velocidade de resposta sem sacrificar controle de marca. |
...
| 10. Ticket Recorrente -> Redução De Volume | O mesmo motivo de contato aparece muitas vezes. | Direct detecta repetição em conversas privadas; Broadcast detecta repetição em espaços compartilhados; QnA publica resposta reutilizável; canais passam a responder antes do ticket. | Ataca a causa do volume, não apenas a fila. |

### Mercado, Produto E Decisão

| Processo | Situação | Módulos sem conflito | Valor |
| --- | --- | --- | --- |
| 11. Campanha -> Mapa De Objeções | Uma campanha gera comentários, dúvidas e resistência. | Broadcast captura reações; QnA estrutura respostas reutilizáveis; Direct usa as respostas em conversas privadas; marketing ajusta criativos, landing pages e argumentos como área humana. | Melhora a performance de campanhas a partir das perguntas reais do mercado. |
| 12. Feedback De Produto -> Decisão De Roadmap | Usuários pedem melhorias, reportam confusão ou questionam limites do produto. | Broadcast identifica temas públicos e comunitários; Direct pode registrar feedback privado; Trust prioriza quando existe regra de decisão; QnA publica status, racional ou próximos passos definidos. | Transforma demanda dispersa em decisão transparente. |
...
| 16. Parceiros E Revendas -> Conhecimento Controlado | Parceiros precisam de respostas por audiência, mas nem sempre devem ver tudo. | QnA entrega respostas por audiência; Direct atende parceiros em portal ou canal privado; Tenant controla acesso e entitlement; lacunas retornam para QnA. | Escala suporte de canal sem perder controle sobre permissão e mensagem. |
