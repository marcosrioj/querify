...
using Querify.Common.EntityFramework.Tenant.Security;
...
namespace Querify.Common.EntityFramework.Tenant;
        ...
        httpContextAccessor)
{
    ...
    [
        "Querify.Common.EntityFramework.Tenant.Configurations"
    ];
