    ...
    : IRequestHandler<KnowledgeSourcesGetKnowledgeSourceListQuery, PagedResultDto<KnowledgeSourceDto>>
{
    public Task<PagedResultDto<KnowledgeSourceDto>> Handle(
        KnowledgeSourcesGetKnowledgeSourceListQuery request,
    ...
    private static async Task<PagedResultDto<KnowledgeSourceDto>> GetPagedResultAsync(
        IQueryable<Common.Persistence.QnADb.Entities.KnowledgeSource> query,
        KnowledgeSourceGetAllRequestDto request,
        CancellationToken cancellationToken)
    {
