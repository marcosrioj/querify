...
public sealed class TestContext : IDisposable
{
    ...
    public static TestContext Create(Guid? tenantId = null, Guid? userId = null, HttpContext? httpContext = null)
    {
        ...
        var resolvedHttpContext = httpContext ?? IntegrationTestHttpContextFactory.Create("TenantPublicTest/1.0");
        IntegrationTestHttpContextFactory.ApplyDefaults(resolvedHttpContext, "TenantPublicTest/1.0");
