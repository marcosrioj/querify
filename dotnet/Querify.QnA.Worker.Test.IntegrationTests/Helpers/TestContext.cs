...
public sealed class TestContext : IDisposable
{
    ...
    public static TestContext Create(Guid? tenantId = null, Guid? userId = null, HttpContext? httpContext = null)
    {
        ...
        var resolvedHttpContext = httpContext ?? IntegrationTestHttpContextFactory.Create("QnAWorkerTest/1.0");
        IntegrationTestHttpContextFactory.ApplyDefaults(resolvedHttpContext, "QnAWorkerTest/1.0");
        ...
        return new TestContext(dbContext, sessionService, httpContextAccessor, database);
    }
