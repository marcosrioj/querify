...
public sealed class KnowledgeSource : DomainEntity
{
    ...
    internal void AttachToSpace(QuestionSpace space)
    {
        ...
        EnsureSameTenant(space, "knowledge source to question space");
    ...
    internal void AttachToQuestion(QuestionSourceLink link)
    {
        ...
        EnsureSameTenant(link, "knowledge source to question source link");
    ...
    {
        ArgumentNullException.ThrowIfNull(link);
        EnsureSameTenant(link, "knowledge source to answer source link");
