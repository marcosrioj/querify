...
public sealed class Activity : DomainEntity
{
        ...
        : base(DomainGuards.TenantIdOf(question, nameof(question)), createdBy, occurredAtUtc)
    {
        ...
        {
            EnsureSameTenant(question, answer, "activity question and answer");
            DomainGuards.Ensure(answer.QuestionId == question.Id, "Activity answer must belong to the same question.");
        }
    ...
    public static Activity ForQuestion(
        Question question,
        ActivityKind kind,
    ...
    public static Activity ForAnswer(
        Question question,
        Answer answer,
        ActivityKind kind,
        ActorKind actorKind = ActorKind.System,
    ...
    {
        throw new InvalidOperationException("Activity is append-only and cannot be archived.");
    }
}
