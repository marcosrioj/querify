...
public sealed class TestContext : IDisposable
{
    ...
    public static TestContext Create(Guid? tenantId = null, Guid? userId = null, HttpContext? httpContext = null)
    {
        ...
        var resolvedHttpContext = httpContext ?? IntegrationTestHttpContextFactory.Create("TenantPortalTest/1.0");
        IntegrationTestHttpContextFactory.ApplyDefaults(resolvedHttpContext, "TenantPortalTest/1.0");
