    ...
    : IRequestHandler<TenantConnectionsGetTenantConnectionListQuery, PagedResultDto<TenantConnectionDto>>
{
    ...
    private static IQueryable<Querify.Common.EntityFramework.Tenant.Entities.TenantConnection> ApplySorting(
        IQueryable<Querify.Common.EntityFramework.Tenant.Entities.TenantConnection> query, string? sorting)
    {
        ...
        IOrderedQueryable<Querify.Common.EntityFramework.Tenant.Entities.TenantConnection>? orderedQuery = null;
    ...
    private static IOrderedQueryable<Querify.Common.EntityFramework.Tenant.Entities.TenantConnection> ApplyOrder(
        IQueryable<Querify.Common.EntityFramework.Tenant.Entities.TenantConnection> query,
        string fieldName,
        bool desc,
        bool isFirst)
    {
        return fieldName.ToLowerInvariant() switch
        {
            "module" => isFirst
                ...
                : (desc
                    ? ((IOrderedQueryable<Querify.Common.EntityFramework.Tenant.Entities.TenantConnection>)query)
