    ...
    : IRequestHandler<TenantsGetTenantListQuery, PagedResultDto<TenantDto>>
{
    ...
    private static IQueryable<Querify.Common.EntityFramework.Tenant.Entities.Tenant> ApplySorting(
        IQueryable<Querify.Common.EntityFramework.Tenant.Entities.Tenant> query, string? sorting)
    {
        ...
        IOrderedQueryable<Querify.Common.EntityFramework.Tenant.Entities.Tenant>? orderedQuery = null;
    ...
    private static IOrderedQueryable<Querify.Common.EntityFramework.Tenant.Entities.Tenant> ApplyOrder(
        IQueryable<Querify.Common.EntityFramework.Tenant.Entities.Tenant> query,
        string fieldName,
        bool desc,
        bool isFirst)
    {
        return fieldName.ToLowerInvariant() switch
        {
            "name" => isFirst
                ...
                : (desc
                    ? ((IOrderedQueryable<Querify.Common.EntityFramework.Tenant.Entities.Tenant>)query)
