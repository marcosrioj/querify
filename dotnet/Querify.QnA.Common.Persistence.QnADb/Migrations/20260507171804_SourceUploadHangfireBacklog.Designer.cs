...
namespace Querify.QnA.Common.Persistence.QnADb.Migrations
{
    ...
    [Migration("20260507171804_SourceUploadHangfireBacklog")]
    partial class SourceUploadHangfireBacklog
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Querify.QnA.Common.Domain.Entities.Activity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Querify.QnA.Common.Domain.Entities.AnswerSourceLink", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Querify.QnA.Common.Domain.Entities.Question", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Querify.QnA.Common.Domain.Entities.QuestionSourceLink", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Querify.QnA.Common.Domain.Entities.QuestionTag", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Querify.QnA.Common.Domain.Entities.Source", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("UploadChecksum")
                        .HasMaxLength(256)
            ...
            modelBuilder.Entity("Querify.QnA.Common.Domain.Entities.SpaceTag", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Querify.QnA.Common.Domain.Entities.Tag", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Querify.QnA.Common.Domain.Entities.Activity", b =>
                {
                    b.HasOne("Querify.QnA.Common.Domain.Entities.Answer", "Answer")
                        .WithMany()
                        .HasForeignKey("AnswerId");

                    b.HasOne("Querify.QnA.Common.Domain.Entities.Question", "Question")
                        .WithMany("Activities")
            ...
            modelBuilder.Entity("Querify.QnA.Common.Domain.Entities.Question", b =>
                {
                    b.HasOne("Querify.QnA.Common.Domain.Entities.Answer", "AcceptedAnswer")
                        .WithMany()
            ...
            modelBuilder.Entity("Querify.QnA.Common.Domain.Entities.QuestionTag", b =>
                {
                    ...
                    b.HasOne("Querify.QnA.Common.Domain.Entities.Tag", "Tag")
                        .WithMany("Questions")
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
