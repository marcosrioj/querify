...
namespace Querify.QnA.Common.Persistence.QnADb.Migrations
{
    ...
    [Migration("20260430171548_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Querify.Common.EntityFramework.Core.AutoHistory.AutoHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("__ChangeHistory", (string)null);
                });

            modelBuilder.Entity("Querify.QnA.Common.Persistence.QnADb.Entities.Activity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Querify.QnA.Common.Persistence.QnADb.Entities.Answer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Querify.QnA.Common.Persistence.QnADb.Entities.AnswerSourceLink", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Querify.QnA.Common.Persistence.QnADb.Entities.Question", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Querify.QnA.Common.Persistence.QnADb.Entities.QuestionSourceLink", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Querify.QnA.Common.Persistence.QnADb.Entities.QuestionTag", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Querify.QnA.Common.Persistence.QnADb.Entities.Source", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Querify.QnA.Common.Persistence.QnADb.Entities.Space", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Querify.QnA.Common.Persistence.QnADb.Entities.SpaceSource", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Querify.QnA.Common.Persistence.QnADb.Entities.SpaceTag", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Querify.QnA.Common.Persistence.QnADb.Entities.Tag", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Querify.QnA.Common.Persistence.QnADb.Entities.Activity", b =>
                {
                    b.HasOne("Querify.QnA.Common.Persistence.QnADb.Entities.Answer", "Answer")
                        .WithMany()
                        .HasForeignKey("AnswerId");

                    b.HasOne("Querify.QnA.Common.Persistence.QnADb.Entities.Question", "Question")
                        .WithMany("Activities")
            ...
            modelBuilder.Entity("Querify.QnA.Common.Persistence.QnADb.Entities.AnswerSourceLink", b =>
                {
                    ...
                    b.HasOne("Querify.QnA.Common.Persistence.QnADb.Entities.Source", "Source")
                        .WithMany("Answers")
            ...
            modelBuilder.Entity("Querify.QnA.Common.Persistence.QnADb.Entities.Question", b =>
                {
                    b.HasOne("Querify.QnA.Common.Persistence.QnADb.Entities.Answer", "AcceptedAnswer")
                        .WithMany()
                        .HasForeignKey("AcceptedAnswerId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("Querify.QnA.Common.Persistence.QnADb.Entities.Space", "Space")
                        .WithMany("Questions")
            ...
            modelBuilder.Entity("Querify.QnA.Common.Persistence.QnADb.Entities.QuestionTag", b =>
                {
                    ...
                    b.HasOne("Querify.QnA.Common.Persistence.QnADb.Entities.Tag", "Tag")
                        .WithMany("Questions")
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
