...
namespace BaseFaq.QnA.Common.Persistence.QnADb.Migrations
{
    ...
    [Migration("20260501141617_VisibilityDefaultValueUpdated")]
    partial class VisibilityDefaultValueUpdated
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BaseFaq.Common.EntityFramework.Core.AutoHistory.AutoHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BaseFaq.QnA.Common.Domain.Entities.Activity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BaseFaq.QnA.Common.Domain.Entities.Answer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BaseFaq.QnA.Common.Domain.Entities.AnswerSourceLink", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BaseFaq.QnA.Common.Domain.Entities.Question", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BaseFaq.QnA.Common.Domain.Entities.QuestionSourceLink", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BaseFaq.QnA.Common.Domain.Entities.QuestionTag", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BaseFaq.QnA.Common.Domain.Entities.Source", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BaseFaq.QnA.Common.Domain.Entities.Space", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BaseFaq.QnA.Common.Domain.Entities.SpaceSource", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BaseFaq.QnA.Common.Domain.Entities.SpaceTag", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BaseFaq.QnA.Common.Domain.Entities.Tag", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BaseFaq.QnA.Common.Domain.Entities.Activity", b =>
                {
                    b.HasOne("BaseFaq.QnA.Common.Domain.Entities.Answer", "Answer")
                        .WithMany()
                        .HasForeignKey("AnswerId");

                    b.HasOne("BaseFaq.QnA.Common.Domain.Entities.Question", "Question")
                        .WithMany("Activities")
            ...
            modelBuilder.Entity("BaseFaq.QnA.Common.Domain.Entities.AnswerSourceLink", b =>
                {
                    ...
                    b.HasOne("BaseFaq.QnA.Common.Domain.Entities.Source", "Source")
                        .WithMany("Answers")
            ...
            modelBuilder.Entity("BaseFaq.QnA.Common.Domain.Entities.Question", b =>
                {
                    b.HasOne("BaseFaq.QnA.Common.Domain.Entities.Answer", "AcceptedAnswer")
                        .WithMany()
                        .HasForeignKey("AcceptedAnswerId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("BaseFaq.QnA.Common.Domain.Entities.Space", "Space")
                        .WithMany("Questions")
            ...
            modelBuilder.Entity("BaseFaq.QnA.Common.Domain.Entities.QuestionTag", b =>
                {
                    ...
                    b.HasOne("BaseFaq.QnA.Common.Domain.Entities.Tag", "Tag")
                        .WithMany("Questions")
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
