...
public sealed class BillingSeedService : IBillingSeedService
{
    ...
    private static void SeedScenarioA_NorthPeakAnalytics(TenantDbContext dbContext, string productConnectionString)
    {
        ...
        EnsureBillingProviderSubscription(dbContext, PsNorthPeakId,
            ...
            externalProductId: "prod_1RProdProBaseFaq",
            status: TenantSubscriptionStatus.Active,
            periodStart: SeedNow.AddDays(-9),
            periodEnd: SeedNow.AddDays(21),
            lastEvent: SeedNow.AddDays(-9));
    ...
    private static void SeedScenarioC_MapleForgeMedia(TenantDbContext dbContext, string productConnectionString)
    {
        ...
        EnsureBillingPayment(dbContext, PayMapleForge1Id,
            ...
            failureMessage: "Your card was declined. Please update your payment method to continue your BaseFaq subscription.",
            lastEvent: SeedNow.AddDays(-5));
    ...
    private static void SeedScenarioE_BlueHarborLegal(TenantDbContext dbContext, string productConnectionString)
    {
        ...
        EnsureBillingProviderSubscription(dbContext, PsBlueHarborId,
            ...
            externalProductId: "prod_1RProdBusinessBaseFaq",
            status: TenantSubscriptionStatus.Active,
            periodStart: SeedNow.AddDays(-2),
            periodEnd: SeedNow.AddDays(28),
            lastEvent: SeedNow.AddDays(-2));
    ...
    private static void SeedEmailOutboxSamples(TenantDbContext dbContext)
    {
        ...
        EnsureEmailOutbox(dbContext, Email1Id,
            ...
            subject: "Your BaseFaq invoice receipt — April 2026",
            htmlBody: "<p>Hi BlueHarbor Legal,</p><p>Your BaseFaq Business monthly subscription renewed successfully. Invoice amount: CAD $299.00. Thank you for your continued trust in BaseFaq.</p>",
            textBody: "Your BaseFaq Business monthly subscription renewed successfully. Invoice amount: CAD $299.00.",
            fromEmail: "billing@basefaq.com",
            fromName: "BaseFaq Billing",
            status: ControlPlaneMessageStatus.Pending,
        ...
        EnsureEmailOutbox(dbContext, Email2Id,
            ...
            subject: "Payment issue on your BaseFaq subscription",
            htmlBody: "<p>Hi MapleForge Media,</p><p>We were unable to process your latest BaseFaq subscription payment. Please update your payment method to avoid interruption to your service. Your account remains active during the grace period ending April 17, 2026.</p>",
            textBody: "We were unable to process your latest BaseFaq subscription payment. Please update your payment method to avoid interruption.",
            fromEmail: "billing@basefaq.com",
            fromName: "BaseFaq Billing",
            status: ControlPlaneMessageStatus.Completed,
        ...
        EnsureEmailOutbox(dbContext, Email3Id,
            ...
            subject: "Action required: add a payment method before your BaseFaq trial ends",
            htmlBody: "<p>Hi Pacific Trail Studio,</p><p>Your BaseFaq trial is active and will end on May 15, 2026. To avoid losing access, please add a payment method to continue on the Starter plan at CAD $29.00/month.</p>",
            textBody: "Your BaseFaq trial is active and will end on May 15, 2026. Please add a payment method to continue.",
            fromEmail: "billing@basefaq.com",
            fromName: "BaseFaq Billing",
            status: ControlPlaneMessageStatus.Failed,
        ...
        string payloadJson = "{}")
    {
        ...
        if (entity is null)
        {
            entity = new BillingWebhookInbox
            {
                ...
                SignatureValid = true,
                IsLiveMode = false,
                ProviderAccountId = "acct_1RBaseFaqStripe",
        ...
        else
        {
            ...
            entity.ProviderAccountId = "acct_1RBaseFaqStripe";
