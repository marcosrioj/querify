...
using BaseFaq.QnA.Portal.Business.Space.Commands.AddCuratedSource;
using BaseFaq.QnA.Portal.Business.Space.Commands.AddTag;
using BaseFaq.QnA.Portal.Business.Space.Commands.CreateSpace;
using BaseFaq.QnA.Portal.Business.Space.Commands.DeleteSpace;
using BaseFaq.QnA.Portal.Business.Space.Commands.RemoveCuratedSource;
using BaseFaq.QnA.Portal.Business.Space.Commands.RemoveTag;
using BaseFaq.QnA.Portal.Business.Space.Commands.UpdateSpace;
using BaseFaq.QnA.Portal.Business.Space.Queries.GetSpace;
using BaseFaq.QnA.Portal.Business.Space.Queries.GetSpaceList;
using MediatR;

namespace BaseFaq.QnA.Portal.Business.Space.Service;
