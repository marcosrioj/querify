...
export const sourceKeys = {
  ...
  list: (params: Record<string, unknown>) => [...sourceKeys.all, 'list', params] as const,
...
export function useSourceList(params: {
  ...
  return useQuery({
    ...
    queryFn: ({ signal }) => listSources(session?.accessToken, currentTenantId, params, signal),
...
export function useDeleteSource() {
  ...
  return useMutation({
    ...
    mutationFn: (id: string) => deleteSource(session?.accessToken, currentTenantId, id),
    onSuccess: async () => {
