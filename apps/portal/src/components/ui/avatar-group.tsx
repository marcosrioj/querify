      ...
      <AnimatePresence mode="wait">
        {hoveredIndex && tooltipContent && (
          <motion.div
            ...
            className={cn(
              "absolute -top-16 left-1/2 z-50 flex -translate-x-1/2 flex-col items-center justify-center rounded-md border border-border bg-popover px-4 py-2 text-xs font-medium text-popover-foreground shadow-xl shadow-black/10 dark:shadow-black/35",
