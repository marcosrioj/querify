...
export const buttonVariants = cva(
  "group inline-flex cursor-pointer items-center justify-center whitespace-nowrap text-sm font-medium ring-offset-background transition-[background-color,border-color,color,box-shadow,transform] has-data-[arrow=true]:justify-between focus-visible:outline-hidden disabled:pointer-events-none disabled:opacity-60 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        primary:
    ...
    compoundVariants: [
      ...
      },
      {
        ...
        appearance: "default",
        className:
          "shadow-[0_14px_30px_-14px_rgba(16,185,129,0.8)] hover:-translate-y-px hover:shadow-[0_18px_34px_-16px_rgba(16,185,129,0.9)]",
      },
      {
        variant: "mono",
        mode: "default",
