...
- Persistence contexts: `TenantDb`, `FaqDb`
...
- It starts the base services using `docker/docker-compose.baseservices.yml` and creates:
  `bf_tenant_db`, `bf_faq_db_01`, and `bf_faq_db_02`.
...
AI runtime notes:
- Generation and matching workers are stateless and do not persist AI lifecycle state.
...
- PostgreSQL: `localhost:5432` (databases `bf_tenant_db`, `bf_faq_db_01`, `bf_faq_db_02`)
